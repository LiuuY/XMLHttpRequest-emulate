...
import { RCTNetworking } from './mockNetworking';
 ...
 */
class XMLHttpRequest extends (EventTarget(XHR_EVENTS) as any) {
  ...
  static _interceptor: XHRInterceptor | null | undefined = null;
  ...
  _requestId: number | null | undefined;
  ...
  _perfKey: string | null | undefined = null;
  _response: string | (Object | null | undefined);
  _responseType: ResponseType;
  _sent: boolean;
  _url: string | null | undefined = null;
  _timedOut: boolean = false;
  _trackingName: string = 'unknown';
  _incrementalEvents: boolean = false;

  static setInterceptor(interceptor: XHRInterceptor | null | undefined) {
  ...
  get response(): Response {
    ...
    switch (responseType) {
      ...
      case 'arraybuffer':
        // this._cachedResponse = toByteArray(
        //   // @ts-ignore
        //   this._response
        // ).buffer;
        this._cachedResponse = this._response;
        break;
  ...
  send(data: any): void {
    ...
    this._subscriptions.push(
      RCTNetworking.addListener('didReceiveNetworkData', (args) => {
        console.log(args);
        this.__didReceiveData(args.requestId, args.data);
      })
    );
    this._subscriptions.push(
      ...
      RCTNetworking.sendRequest(
        {
          method: this._method,
          url: this._url,
          data: { ...body, trackingName: this._trackingName },
          headers: this._headers,
          responseType: nativeResponseType,
          incrementalUpdates: incrementalEvents,
          timeout: this.timeout,
          withCredentials: this.withCredentials,
        },
        this.__didCreateRequest.bind(this)
      );
      console.group(this._url);
